  ...
  return (
    <section id="contact" className="py-24 px-4 md:px-6">
      <div className="container mx-auto max-w-3xl">
        <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-12 text-center">{t("contact.title")}</h2>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <p className="text-neutral-600 dark:text-neutral-300">+55 67 9 9944-1458</p>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="h-5 w-5 text-neutral-400" />
                <p className="text-neutral-600 dark:text-neutral-300">contato@viniccius.com.br</p>
              </div>
            </div>
          </div>
